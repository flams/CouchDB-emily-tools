...
this.stopListening();delete this.stopListening};this.onChange=function(){};this.onAdd=function(){};this.onRemove=function(){};this.setSyncInfo=function(a){return c=a}}return function(g){e.prototype=new j(g);return new e}});
define("CouchDBDocument",["Store","CouchDBBase","Tools","Promise","StateMachine"],function(j,i,g,e,l){function b(){this.setSyncInfo=function(a,c,b){return typeof a=="string"&&typeof c=="string"?!b||typeof b=="object"?{database:a,document:c,query:b||{}}:false:false};this.onSync=function(){var a=this.getSyncInfo();this.getTransport().request(this.getHandlerName(),{method:"GET",path:"/"+a.database+"/"+a.document,query:a.query},function(a){var b=JSON.parse(a);b._id?(this.reset(b),this.getStateMachine().event("listen"),
this.getPromise().fulfill(this)):this.getPromise().reject(a)},this)};this.onListen=function(){var a=this.getSyncInfo();this.stopListening=this.getTransport().listen(this.getHandlerName(),{path:"/"+a.database+"/_changes",query:{feed:"continuous",heartbeat:2E4,descending:true}},function(c){if(c=="\n")return false;c=JSON.parse(c);c.id==a.document&&c.changes.pop().rev!=this.get("_rev")&&(c.deleted?this.getStateMachine().event("remove"):this.getStateMachine().event("change"))},this)};this.onChange=function(){var a=
...
this]],Listening:[["unsync",this.unsync,this,"Unsynched"],["change",this.onChange,this],["add",this.onAdd,this],["remove",this.onRemove,this],["upload",this.databaseUpdate,this],["removeFromDatabase",this.databaseRemove,this]]}))}return function(a){b.prototype=new i(a);return new b}});
