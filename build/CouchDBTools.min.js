...
function(b){return typeof b=="object"&&typeof b.request=="function"&&typeof b.listen=="function"?(a=b,true):false};this.getHandlerName=function(){return c};this.setHandlerName=function(a){return typeof a=="string"?(c=a,true):false};this.sync=function(){return(b=this.setSyncInfo.apply(this,arguments))?(e.event("sync"),d):false};this.unsync=function(){return e.event("unsync")};this.getSyncInfo=function(){return b};this.onSync=function(){};this.onListen=function(){};this.unsync=function(){this.stopListening&&
this.stopListening();delete this.stopListening};this.onChange=function(){};this.onAdd=function(){};this.onRemove=function(){};this.setSyncInfo=function(a){return b=a}}return function(f){e.prototype=new j(f);return new e}});
define("CouchDBDocument",["Store","CouchDBBase","Tools","Promise","StateMachine"],function(j,h,f,e,k){function c(){this.setSyncInfo=function(a,b,d){return typeof a=="string"&&typeof b=="string"?!d||typeof d=="object"?{database:a,document:b,query:d||{}}:false:false};this.onSync=function(){var a=this.getSyncInfo();this.getTransport().request(this.getHandlerName(),{method:"GET",path:"/"+a.database+"/"+a.document,query:a.query},function(a){var d=JSON.parse(a);d._id?(this.reset(d),this.getStateMachine().event("listen"),
this.getPromise().fulfill(this)):this.getPromise().reject(a)},this)};this.onListen=function(){var a=this.getSyncInfo();this.stopListening=this.getTransport().listen(this.getHandlerName(),{path:"/"+a.database+"/_changes",query:{feed:"continuous",heartbeat:2E4,descending:true}},function(b){if(b=="\n")return false;b=JSON.parse(b);b.id==a.document&&b.changes.pop().rev!=this.get("_rev")&&(b.deleted?this.getStateMachine().event("remove"):this.getStateMachine().event("change"))},this)};this.onChange=function(){var a=
...
this.unsync,this,"Unsynched"],["change",this.onChange,this],["add",this.onAdd,this],["remove",this.onRemove,this],["updateReduced",this.updateReduced,this]]}))}return function(c){k.prototype=new h(c);return new k}});
...
this],["remove",this.onRemove,this],["upload",this.databaseUpdate,this]]}))}return function(a){c.prototype=new h(a);return new c}});
